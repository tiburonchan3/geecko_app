  ...
  return (
    <ScrollView style={styles.body}>
      ...
      <View>
        ...
        {user._id === params.user._id && (
          <TouchableHighlight onPress={()=>setShowModalP(true)} style={styles.addButton}>
            <Text style={styles.textAddButton}>Agregar</Text>
          </TouchableHighlight>
        )}
        <PublicationModal showModalP={showModalP} setShowModalP={setShowModalP}/>
        <PublicationList navigation={navigation} user={userInfo} />
      </View>
    </ScrollView>
  );
}
